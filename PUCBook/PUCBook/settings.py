"""
Django settings for PUCBook project.
...
SECRET_KEY = 'django-insecure-x^r&ef(#^)6cx=7-vh!kpf22s35007ec9y_q64_!@7^@r49mko'
...
WSGI_APPLICATION = 'PUCBook.wsgi.application'
...
STATIC_URL = '/PUCBook/PUCBook_Site/static/'
AUTH_USER_MODEL = "PUCBook_Site.Usuario" 
